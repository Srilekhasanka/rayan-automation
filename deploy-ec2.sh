...
echo ""
echo "═══════════════════════════════════════════════════════════"
echo " Next steps (run on EACH server):"
echo "═══════════════════════════════════════════════════════════"
echo "  1. Wait ~5 min for setup to complete"
echo "  2. SSH:  ssh -L 5901:localhost:5901 ubuntu@<ip>"
echo "  3. Check setup: cat /home/appuser/setup-complete.flag"
echo "  4. VNC:  connect to localhost:5901 (password: changeme)"
echo "  5. Auth: sudo -u appuser /home/appuser/app/run-auth.sh"
echo "  6. Run:  sudo -u appuser /home/appuser/app/run-tests.sh"
echo "═══════════════════════════════════════════════════════════"
